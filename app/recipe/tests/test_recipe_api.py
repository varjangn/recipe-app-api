...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test retriving list of recipes limited to user"""
    ...
    def test_get_recipe_detail(self):
        """Test recipe detail api to return recipe details of single item"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test createing a recipe with new ingredients"""
        payload = {
    ...
    def test_create_recipe_with_existing_ingredient(self):
        """Test creating a new recipe with existsting ingredient."""
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Indian Khichadi')
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_request(self):
        ...
        url = image_upload_url(self.recipe.id)
        payload = {'image': 'imagefieldcannotbestring'}
        res = self.client.post(url, payload, format='multipart')
